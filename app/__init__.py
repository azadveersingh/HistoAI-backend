...
from .routes import auth, profile, structured_data, token_usage, file_routes, otp_auth, project_routes, admin_routes, book_routes, collection_routes,file_serve_routes
...
def create_app():
    ...
    app.register_blueprint(structured_data.structured_bp)
